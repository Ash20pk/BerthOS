...
@berth/agents' providers/anthropic.ts (message-mapping logic only; that
file's chatStream()/maxRetries plumbing isn't ported in this first slice)."""
...
from ..types import AgentMessage, LLMTurn, Tool, ToolCall
