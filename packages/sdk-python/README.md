...
Python resident-app SDK for [Berth](https://github.com/Ash20pk/BerthOS) — capability-scoped, kernel-enforced sandboxes for AI agents. Speaks the same wire protocols as `@berth/sdk` (newline-JSON RPC framing, the `berth.yml` manifest shape) with idiomatic Python runtime glue.
